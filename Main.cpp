...
void bankAccount::createAccount()   {
    ...
    balance = 500.0;
    ifstream file("Nikhil-Kumar-Bank-Of-India.txt");
    if(file.is_open())  {

        file>>bankCode;
        file.close();
        ofstream output("Nikhil-Kumar-Bank-Of-India.txt");
...
void bankAccount::accountDetails() {
    ...
    Magenta();
    cout<<"|------------------------------|"<<endl;
    cout<<"|  Nikhil Kumar Bank Of India   |"<<endl;
    cout<<"|------------------------------|"<<endl;
    Blue();
...
int main() {
    ...
    do {
        cout<<" Welcome to Nikhil Kumar Bank Of India" << endl;
        cout<<"--------------------------------------"<<endl;
